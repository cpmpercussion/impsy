...
<section class="container py-5">
  <div class="row align-items-center g-5">
    ...
    <div class="col-md-6">
      ...
      <p class="mb-0">
        The companion <a href="{{ site.links.pi }}">IMPSYpi</a> distribution packages the toolkit for Raspberry Pi Zero 2 W, 3, 4, and 5 so that an intelligent instrument can run untethered on stage, the <a href="{{ site.links.auv3 }}">IMPSY AUv3</a> app runs the same models as a MIDI plugin (or standalone) on iOS and macOS, and <a href="{{ site.links.web }}">IMPSY Web</a> runs them client-side in a browser. The <a href="{{ '/workshop/' | relative_url }}">IMPSYpi workshop</a> walks through the whole process end to end.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <p>
        ...
        the AUv3 app, the browser version, and this site all live on GitHub — issues and pull requests are welcome.
      </p>
